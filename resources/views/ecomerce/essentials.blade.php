...
<section style="background:#000; color:#fff; min-height:85vh; display:flex; align-items:center; justify-content:center; padding:80px 40px;">
    <div style="width:100%; max-width:1100px; text-align:center;">
        ...
        <h1 style="font-family:'Bebas Neue', sans-serif; font-size:96px; letter-spacing:8px; line-height:0.95; margin-bottom:20px;">ESSENTIALS</h1>
        <p style="font-size:14px; letter-spacing:3px; text-transform:uppercase; opacity:0.7; margin-bottom:32px;">Ropa limpia, precisa y sin complicaciones.</p>
...
<section id="catalogo" style="padding:80px 40px;">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:36px; flex-wrap:wrap; gap:16px;">
        <div>
            ...
            <h2 style="font-family:'Bebas Neue', sans-serif; font-size:44px; letter-spacing:4px;">ROPA ESSENTIALS</h2>
        </div>
    </div>
